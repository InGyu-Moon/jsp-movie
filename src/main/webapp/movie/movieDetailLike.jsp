...
<body>
	...
	<div class="layer-wrap">
		<input type="hidden" name="username" id="username"
			value="<%=username%>"> <input type="hidden" name="movie_id"
			id="movie_id" value="<%=movie_id%>"> <input type="hidden"
			name="member_id" id="member_id" value="<%=memberId%>">
