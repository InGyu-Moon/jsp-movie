...
<body>
	...
	<div class="center">
		...
		<div class="container-rightside" style="width: 80%;">
			<h2 style="margin-bottom: 50px">FAQ 수정</h2>
					...
					<div class="row mb-3">
						...
						<div class="col-sm-2">
							<select class="form-select" aria-label="Default select example" name="category">
								<option value="전체" <%=faq.getCategory().equals("전체") ? "selected":"" %>>전체</option>
								<option value="영화관" <%=faq.getCategory().equals("영화관") ? "selected":"" %>>영화관</option>
								<option value="이벤트" <%=faq.getCategory().equals("이벤트") ? "selected":"" %>>이벤트</option>
								<option value="혜택" <%=faq.getCategory().equals("혜택") ? "selected":"" %>>혜택</option>
							</select>
						</div>
					</div>
					<div class="mb-3">
