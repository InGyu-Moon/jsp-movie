...
<div class="center">
    ...
    <div class="container-rightside" style="width: 80%;">
        <h2 style="margin-bottom: 50px">공지사항 추가</h2>
        <hr style="margin-bottom: 30px">

        <div class="container">
            <h2>게시판 글쓰기</h2>
            <form action="notice/noticeInsert.jsp" method="post">
                <div class="row mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="title"
                           name="title" maxlength="100" required="required" placeholder="공지사항 제목 작성"
                           pattern=".{4,100}">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" rows="5" id="content"
                              name="content" placeholder="공지사항 내용 작성"></textarea>
                </div>
