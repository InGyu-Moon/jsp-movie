...
<div class="center">
	<div class="container-rightside" style="width: 80%;">
		<h2 style="margin-bottom: 50px">1:1 문의 수정</h2>
		<hr style="margin-bottom: 30px">
		<br>
		<%-- 문의 디테일 출력 --%>
		<h3>문의 내용</h3>
		<form action="inquiry/inquiryUpdateAction.jsp" method="post" ><!-- enctype="multipart/form-data" -->
			...
			<table class="table">
				<tr>
					...
					<select name="inquiryOption" class="form-select " style="width: 110px;">
				        ...
				        <option value="예매_결제" <%=option.equals("예매_결제")? "selected" : ""%>>예매/결제</option>
				...
				<tr>
					<th>답변할 내용</th>
					<td>
						<textarea name="answer" class="form-control" rows="10" cols="75"><%=inquiry.getAnswer()%></textarea>		
					</td>
				</tr>
			</table>
			<div style="float: right;">
				...
				<button type="button" class="btn btn-outline-success" 
						onclick="location.href='?curr=inquiry/inquiryMain.jsp'">목록</button>
			</div>
		</form>
