...
<%
    //전체갯수
    int totalCount=totalMemberList.size()+1;
...
<%--            <a href="<%=dto.getId()%>" class="list-group-item list-group-item-action list-group-item-light"><%=dto.getUserName()%></a>--%>
        ...
        <td>
            <a href="?curr=member/memberDetail.jsp?memberId=<%=dto.getId()%>" type="button" id="btnDetail" class="btn btn-sm btn-outline-success">상세</a>
        </td>
    <tr>
            <%
        }
