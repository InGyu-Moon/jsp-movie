			...
			<div id="myhome">
				...
				<div class="cols-content" id="menu">
				    ...
				    <div class="col-detail" id="mycgv_contents">
						...
						<form name="aspnetForm" method="post" action="updateMyInfo.jsp" id="aspnetForm" >
						<div class="tbl-form">
						    <table>
						        <colgroup>
						        <col width="19%">
						        ...
						        <tbody>
						            <tr>
						                <th scope="row">이름</th>
						                <td><input type="text" name="name" required="required" placeholder="이름" value="<%=dto.getName() %>"></td>
						            </tr>
						            <tr>
						            ...
						            <tr>
						                ...
						                <td>
						                    <input type="password" name="password" id="password" oninput="pwCheck()"  required="required" placeholder="비밀번호 입력" value="<%=dto.getPassword()%>">
						                </td>
						            </tr>
						            <tr>
						                <th scope="row">비밀번호 확인</th>
						                <td>
						                    <input type="password" name="ckeck_password" id="ckeck_password" oninput="pwCheck()"  required="required" placeholder="비밀번호 확인">
						            ...
						            <tr>
										...
										<td>
										    ...
										    <input type="radio" name="gender" value="Male" <%=dto.getGender() == Gender.Male ? "checked" : "" %>>남성&nbsp;
										    <input type="radio" name="gender" value="Female" <%=dto.getGender() == Gender.Female ? "checked" : "" %>>여성&nbsp;
										    <input type="radio" name="gender" value="Other" <%=dto.getGender() == Gender.Other ? "checked" : "" %>>비공개
										</td>
						            </tr>
						            <tr>
										...
										String hp3 = st.nextToken();
										 %>
											...
											-
											<input type="text" name="phone_number2" required="required" value="<%=hp2%>">
											-
											<input type="text" name="phone_number3" required="required" value="<%=hp3%>">
						                </td>
						            </tr>
						            <tr>
						                <th scope="row">이메일</th>
						                <td>
											...
											String email2 = st2.nextToken();
											 %>
						                	<input type="text" name="email1" placeholder="이메일" required="required" value="<%=email1%>">
											@
											<input type="text" name="email2" value="<%=email2 %>" >
											<select id="email_selected">
												<option class="select" value="" <%=dto.getEmail().equals("")?"selected":"" %>>선택</option>
												<option class="select" value="naver.com" <%=dto.getEmail().equals("naver.com")?"selected":"" %>>네이버</option>
												<option class="select" value="daum.net" <%=dto.getEmail().equals("daum.net")?"selected":"" %>>다음</option>
												<option class="select" value="gmail.com" <%=dto.getEmail().equals("gmail.com")?"selected":"" %>>구글</option>
												<option class="select" value="직접입력" <%=!(dto.getEmail().equals("naver.com") || dto.getEmail().equals("daum.net") || dto.getEmail().equals("gmail.com")) ? "selected" : ""%>>직접입력</option>
											</select>
						                </td>
						            </tr>
						            <tr>
						                ...
						                <td>
											...
											%> --%>
						                	<input type="text" id="sample6_postcode" name="address0" required="required" placeholder="우편번호" <%-- value="<%=address0%>" --%>>
											<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
											<input type="text" id="sample6_address" placeholder="주소" name="address1" <%-- value="<%=address1%>" --%>><br>
						...
						<div class="set-btn aright">
							<button type="submit" id="set_profile" class="round inred on"><span>수정</span></button>
							<button type="button" id="set_profile" class="round inblack on" onclick="location.href='myHome.jsp'"><span>취소</span></button>
						</div>
						</form>
					</div>
				</div>
