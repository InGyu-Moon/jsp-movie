					    ...
					    <div class="snb">
					        <ul>
					            ...
					            <li class="on">
				                    ...
				                    <ul>
				                       <li>
				                            <a href="myReserve.jsp" style="color: #fb4357;">예매내역 확인</a>
				                        </li>
				                    </ul>
				                </li>
					            <li>
				                            ...
				                            <div class="reservation-info-wrap store-history" style="display: none;">
				                                <h2>
				                                    <span class="res-title">
				                                        ...
				                                        <button type="button" class="all-goods-btn" title="상품모두 열기/닫기" onclick="fn_SnackVisible(this, '0260202404253748553')">
				                                            <span>전체상품보기버튼</span>
				                                        </button>
				                                    </span>
				                                ...
				                                <ul class="store-goods-list" id="divSnackList0260202404253748553">                                    
				                                </ul>
				                            </div>
				                        </div>
				                    </div>
