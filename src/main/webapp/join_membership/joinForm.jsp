	  ...
	  $("#btnIdCheck").click(function(){
		  ...
		  $.ajax({
			  ...
			  success:function(data){
				  ...
				  if(data.count==1){
					  //alert("이미 가입된 아이디입니다\n다시입력해 주세요");
					  $("span.idsuccess").text("아이디 중복").css("color", "red");
					  $("#username").val("");
				  }else{
					  //alert("가입이 가능한 아이디입니다");
					  $("span.idsuccess").text("아이디 사용가능").css("color", "green");
				  }
			  }
		  }) 
	  });
...
<body>
	...
	<form action="joinAction.jsp" method="post">
		...
		비밀번호 : <input type="password" name="password" id="password" oninput="pwCheck()"  required="required" placeholder="비밀번호 입력"> &nbsp;
		비밀번호 확인 : <input type="password" name="ckeck_password" id="ckeck_password" oninput="pwCheck()"  required="required" placeholder="비밀번호 확인">
		...
		휴대폰 번호 : <select name="phone_number1">
					...
					-
					<input type="text" name="phone_number3" required="required"><br>
		이메일 : <input type="text" name="email1" placeholder="이메일" required="required">
				@
				...
				<br>
		우편번호 : <input type="text" id="sample6_postcode" name="address0" required="required" placeholder="우편번호">
				...
				<input type="text" id="sample6_extraAddress" name="address3" placeholder="참고항목">
		<br>
