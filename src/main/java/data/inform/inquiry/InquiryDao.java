...
public class InquiryDao {
	...
	public void insertAnswer(int inquiryId, String answer) {
		...
		try {
			...
			if(result>0) System.out.println("답변 insert success");
			else System.out.println("답변 insert error");
	...
	public void deleteAnswer(int inquiryId) {
		...
		try {
			...
			if(result>0) System.out.println("답변 delete success");
			else System.out.println("답변 delete error");
